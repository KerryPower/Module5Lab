...
router.get('/filter', (req, res) => {
    ...
    if (filterLetter) {
        matchingFriends = matchingFriends.filter(friend => friend.letter == filterLetter)
    }
...
router.get('/:id', (req, res) => {
    ...
    if (friend) {
        res.status(200).json({ result: 'Found friend with ID ' + friendId, friend: friend });
    } else {
...
router.put('/:id', (req, res) => {
    ...
    if (friendToUpdate) {
        ...
        // Respond with updated friend data
        res.json({ result: 'Updated friend with ID ' + friendId, data: friendToUpdate });
    } else {
        // Friend not found, respond with 404
